    ...
    <div>
      <div className="container mx-auto mt-4">
        <div className="flex justify-center m-5">
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-60 rounded-l-lg ">
            CAR
          </button>
          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 w-60 rounded-r-lg">
            MC
          </button>
        </div>
